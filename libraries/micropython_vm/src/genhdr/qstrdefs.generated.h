...
QDEF1(MP_QSTR_WHITE, 49826, 5, "WHITE")
...
QDEF1(MP_QSTR_a_pressed, 63837, 9, "a_pressed")
QDEF1(MP_QSTR_accel, 36813, 5, "accel")
QDEF1(MP_QSTR_b_pressed, 60254, 9, "b_pressed")
QDEF1(MP_QSTR_bin, 18656, 3, "bin")
QDEF1(MP_QSTR_bound_method, 41623, 12, "bound_method")
QDEF1(MP_QSTR_buttons, 32544, 7, "buttons")
...
QDEF1(MP_QSTR_gyro, 62118, 4, "gyro")
...
QDEF1(MP_QSTR_millis, 8539, 6, "millis")
...
QDEF1(MP_QSTR_stick, 4003, 5, "stick")
QDEF1(MP_QSTR_store, 2586, 5, "store")
QDEF1(MP_QSTR_text, 44952, 4, "text")
QDEF1(MP_QSTR_text2, 41642, 5, "text2")
